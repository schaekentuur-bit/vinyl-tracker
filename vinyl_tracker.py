...
<style>
  ...
  *{{box-sizing:border-box;margin:0;padding:0}}
  body{{font-family:system-ui,-apple-system,'Segoe UI',Roboto,sans-serif;
        font-size:14px;color:var(--text);display:flex;height:100vh;overflow:hidden;
        background:var(--bg)}}
...
<main>
  <div class="topbar-wrap">
    {"" if not static else f'<div class="topbar"><span class="sub" style="margin-right:auto">Snapshot: {now}</span><a class="btn btn-refresh" href="https://github.com/deschakelaar/vinyl-tracker/actions" target="_blank">&#8635; Vernieuwen via GitHub</a><button class="btn btn-pdf" onclick="window.print()">&#128438; PDF</button></div>'}
...
document.getElementById('add-url').addEventListener('keydown',function(e){{
